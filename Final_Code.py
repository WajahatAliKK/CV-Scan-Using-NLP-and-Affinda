...
resume = fileConv(r"C:\Users\Wajahat Ali\Downloads\cv_scan\temp\CV_-_EMPLOYABILITY_TRAINER_-SEETEC.docx")  # Resume File Path
...
jobDesc = fileConv(r"C:\Users\Wajahat Ali\Downloads\cv_scan\temp\JOB_DESCRIPTION_-_Employability_Trainer.docx")  # Job Description File Path
...
client_id = "6diyz1zk7zhkyrgz"  # replace 'your_client_id' with your client id from your api invite email
client_secret = "O6pLODpP"  # replace 'your_client_secret' with your client secret from your api invite email
...
with open(r'C:\Users\Wajahat Ali\Downloads\cv_scan\SoftSkills-v2.txt') as x:
...
with open(r'C:\Users\Wajahat Ali\Downloads\cv_scan\cliches.txt') as x:
...
with open(r'C:\Users\Wajahat Ali\Downloads\cv_scan\recom.txt') as x:
